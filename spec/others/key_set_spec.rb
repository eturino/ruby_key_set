...
RSpec.describe KeySet do
  ...
  describe '#remove' do
    context 'All' do
      ...
      context 'KeySet.all.remove(KeySet.som([key1, key2]))' do
      ...
      context 'KeySet.all.remove(KeySet.all_except_som([key1, key2]))' do
    ...
    context 'None' do
      ...
      context 'KeySet.none.remove(KeySet.som([key1, key2]))' do
        let(:result) { key_set.remove(described_class.some([key1, key2])) }
      ...
      context 'KeySet.none.remove(KeySet.all_except_som([key1, key2]))' do
        let(:result) { key_set.remove(described_class.all_except_some([key1, key2])) }
